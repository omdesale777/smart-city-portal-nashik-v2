...
/* ─────────────────────────────────────────
   CONFIG
   Update API_BASE to your Render backend URL
   before deploying.
───────────────────────────────────────── */
const CONFIG = {
  API_BASE: 'http://localhost:8000',   // ← change to Render URL on deploy
  SUPABASE_URL: '',                    // ← filled from environment (not used directly in frontend)
};
